Public Class FM090401
    Private Sub FM090401_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim strMaintenanceMenu(3, 1) As String
        Dim strRow(1) As String
        Dim col(1) As DataGridViewTextBoxColumn
        Dim i As Integer
        Dim dgv As DataGridView

        strMaintenanceMenu(0, 0) = "発信文書宛先マスタメンテナンス"
        strMaintenanceMenu(1, 0) = "発信文書差出マスタメンテナンス"
        strMaintenanceMenu(2, 0) = "発信文書委員会マスタメンテナンス"
        strMaintenanceMenu(3, 0) = "都道府県空港マスタメンテナンス"

        strMaintenanceMenu(0, 1) = "UC090402"
        strMaintenanceMenu(1, 1) = "UC090404"
        strMaintenanceMenu(2, 1) = "UC090407"
        strMaintenanceMenu(3, 1) = "UC090410"
