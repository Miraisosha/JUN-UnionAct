Public Class FM090301
    Private Sub FM090301_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim strMaintenanceMenu(0, 1) As String
        Dim strRow(1) As String
        Dim col(1) As DataGridViewTextBoxColumn
        Dim i As Integer
        Dim dgv As DataGridView

        'strMaintenanceMenu(0, 0) = "管理部名簿登録"
        'strMaintenanceMenu(1, 0) = "管理部マスタメンテナンス"
        strMaintenanceMenu(0, 0) = "管理部マスタメンテナンス"

        'strMaintenanceMenu(0, 1) = "UC090302"
        'strMaintenanceMenu(1, 1) = "UC090303"
        strMaintenanceMenu(0, 1) = "UC090307"
