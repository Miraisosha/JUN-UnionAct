...
Public Class UC050202
    ...
    Private Sub InitData()
        Try
            ...
            Dim time As DateTime = DateTime.ParseExact(Me.dsDailyAllowance.Tables.Item("committee_belong_close_list").Rows.Item(Me.OwnerInstance.grdSelectedIdx).Item("d_daily_pay_close").ToString, "yyyyMMdd", Nothing)
            'Dim time As DateTime = DateTime.ParseExact("02", "yyyyMMdd", Nothing) 'TODO
            ...
            Dim time2 As DateTime = CDate(Me.dsDailyAllowance.Tables.Item("committee_close_list").Rows.Item((Me.OwnerInstance.flxCommitteeCloseList.Row - 1)).Item("d_begin"))
            Dim strBelongingId As String = Me.dsDailyAllowance.Tables.Item("committee_belong_close_list").Rows.Item(Me.OwnerInstance.grdSelectedIdx).Item("k_belonging").ToString
            Dim str3 As String = Me.dsDailyAllowance.Tables.Item("committee_belong_close_list").Rows.Item(Me.OwnerInstance.grdSelectedIdx).Item("支部").ToString
            ...
            'Dim table As DataTable = command.GetCommitteeCloseDtl(strBelongingId, Me.dsDailyAllowance.Tables.Item("constant_dtl").Rows.Item(Me.tabPageIdx).Item("c_constant_seq").ToString, strCloseDate).Tables.Item("committee_close_dtl").Copy
            Dim table As DataTable = command.GetCommitteeCloseDtl(strBelongingId, "01", strCloseDate).Tables.Item("committee_close_dtl").Copy
            If Me.dsDailyAllowance.Tables.Contains("committee_close_dtl") Then
                Me.dsDailyAllowance.Tables.Remove("committee_close_dtl")
            End If
            Me.dsDailyAllowance.Tables.Add(table)
            Me.flxDailyPayClose.DataSource = Me.dsDailyAllowance.Tables.Item("committee_close_dtl")
    ...
    Private Sub SetFlexGridStyle()
        Try
            ...
            Next i
            If Not Me.flxDailyPayClose.Cols.Item("print_check") Is Nothing Then
                ...
                'Me.flxDailyPayClose.Cols.Item("社員番号").AllowSorting = False
    ...
    Private Sub btnDailyPayPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDailyPayPrint.Click
        ...
        Try
            ...
            'Dim command As IDailyAllowanceCloseListCommand = DirectCast(class2.GetObject("Business.FinancialAffairs.DailyAllowance.DailyAllowanceCloseListCommand", New Object() {MyBase.objLoginSession}), IDailyAllowanceCloseListCommand)
            Dim command As New DailyAllowanceCloseListCommand
            Dim strBelongingName As String = Me.dsDailyAllowance.Tables.Item("committee_belong_close_list").Rows.Item(Me.OwnerInstance.grdSelectedIdx).Item("支部").ToString
            'New ReportViewer(command.GetCommitteeCloseDtlPrint(Me.dsDailyAllowance.Tables.Item("committee_close_dtl"), printData, strBelongingName, Me.dsDailyAllowance.Tables.Item("constant_dtl").Rows.Item(Me.tabPageIdx).Item("c_constant_seq").ToString, (Me.lblCloseYear.Text.PadLeft(4, "0"c) & Me.lblCloseMonth.Text.PadLeft(2, "0"c) & DateTime.DaysInMonth(Integer.Parse(Me.lblCloseYear.Text), Integer.Parse(Me.lblCloseMonth.Text)))), "Report.CommitteeDailyAllowance.RptCommitteeDailyAllowance").ReportViewerShow
            Dim viewer As New ReportViewer(command.GetCommitteeCloseDtlPrint(Me.dsDailyAllowance.Tables.Item("committee_close_dtl"), printData, strBelongingName, "01", (Me.lblCloseYear.Text.PadLeft(4, "0"c) & Me.lblCloseMonth.Text.PadLeft(2, "0"c) & DateTime.DaysInMonth(Integer.Parse(Me.lblCloseYear.Text), Integer.Parse(Me.lblCloseMonth.Text)))), New CR0502P1)
    ...
    Private Sub flxDailyPayClose_AfterSort(ByVal sender As Object, ByVal e As C1.Win.C1FlexGrid.SortColEventArgs) Handles flxDailyPayClose.AfterSort
        ...
        Dim tb As DataTable = Me.dsDailyAllowance.Tables.Item("committee_close_dtl")
        If Not tb Is Nothing Then
            ...
            Next
            Me.dsDailyAllowance.Tables.Remove("committee_close_dtl")
            ta.TableName = "committee_close_dtl"
