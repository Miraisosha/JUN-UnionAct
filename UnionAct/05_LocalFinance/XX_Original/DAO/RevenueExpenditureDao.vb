    ...
    Friend Class RevenueExpenditureDao
        ...
        Public Function GetRevenueKbnDao(ByVal strDFrom As String, ByVal strControlName As String) As String
            ...
            Try
                ...
                'End If
                If strControlName.Equals("CtlIncomeExpect") Then
                    str = " IIF(REV.k_revenue_member IS NULL, '', REV.k_revenue_member) &  IIF(REV.k_revenue_allotted_charge IS NULL, '', REV.k_revenue_allotted_charge) &  IIF(REV.k_revenue_budgetary_process IS NULL, '', REV.k_revenue_budgetary_process) AS COMMNET "
                ElseIf strControlName.Equals("CtlCrewPlan") Then
                    str = " IIF(REV.k_revenue_allotted_charge IS NULL, '', REV.k_revenue_allotted_charge) &  IIF(REV.k_revenue_budgetary_process IS NULL, '', REV.k_revenue_budgetary_process) AS COMMNET "
                ElseIf strControlName.Equals("CtlAllottedCharge") Then
                    str = " IIF(REV.k_revenue_budgetary_process IS NULL, '', REV.k_revenue_budgetary_process) AS COMMNET "
                Else
                    Return ""
                End If
