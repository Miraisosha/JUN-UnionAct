...
#Region "プロパティ"
    ...
    Public _SelectDataList As DataTable = Nothing
...
#End Region
#Region "イベント"
    Private Sub UC040205_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '-------------------------------------------------------------------------------
        '   各Screen処理
        '-------------------------------------------------------------------------------
        'STRIKE_KIND = strKind
    ...
    Private Sub btnSampleText_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSampleText.Click
        ...
        Try
            ...
            If (strKind = "03") Then
                strSamKenmei = "首題の件、先般通告した全日空乗組 " + strKumi + " 第 " + strStrikeId + " 号に関し、" + vbCrLf
                strSamKenmei = strSamKenmei + "下記の通り解除する。"
                strSamHonbun = ""
                strSamHonbun = strSamHonbun + "１．｢" + strYYYY + "年" + strMM + "月" + strDD + "日00時から24時までの24時間限ストライキ｣" + vbCrLf
                strSamHonbun = strSamHonbun + "　　を解除する。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　但し、別紙記載の者を除く。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "２．｢" + strYYYY1 + "年" + strMM1 + "月" + strDD1 + "日の休日労働(休日移動)｣は一切拒否する" + vbCrLf
                strSamHonbun = strSamHonbun + "　　を解除する。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "３．｢" + strYYYY + "年" + strMM + "月" + strDD + "日に連続4日目の勤務が予定されている者の、" + vbCrLf
                strSamHonbun = strSamHonbun + "　　 " + strYYYY1 + "年" + strMM1 + "月" + strDD1 + "日の乗務・便乗を一切拒否する。｣" + vbCrLf
                strSamHonbun = strSamHonbun + "　　を解除する。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "４．｢B747-400移動勤務者(大阪在住)で、" + strYYYY + "年" + strMM + "月" + strDD + "日が移動予定者" + vbCrLf
                strSamHonbun = strSamHonbun + "　　(大阪→東京)の" + strYYYY1 + "年" + strMM1 + "月" + strDD1 + "日の勤務を一切拒否する。｣" + vbCrLf
                strSamHonbun = strSamHonbun + "　　を解除する。" + vbCrLf + vbCrLf
            ElseIf (strKind = "04") Then
                strSamKenmei = "首題の件、全日空乗組B第" + strStrikeId + "号第2項、第3項に関し、" + vbCrLf
                strSamKenmei = strSamKenmei + "" + strYYYY + "年" + strMM + "月" + strDD + "日に国内線運航宿泊の者で、次に該当する場合に限り、" + vbCrLf
                strSamKenmei = strSamKenmei + "下記の通り解除する。"
                strSamHonbun = ""
                strSamHonbun = strSamHonbun + "１．争議協定(" + strYYYY + "年" + strMM + "月" + strDD + "日)第3項(１)②に定める｢24日が連続する5日目" + vbCrLf
                strSamHonbun = strSamHonbun + "　　とならず、24日が休日の組合員｣に該当する場合に限り、" + vbCrLf
                strSamHonbun = strSamHonbun + "　　第2項｢" + strYYYY + "年" + strMM + "月" + strDD + "日の休日労働(休日移動)は一切拒否する｣を解除する。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "２．争議協定(" + strYYYY + "年" + strMM + "月" + strDD + "日)第3項(１)③に定める｢24日が連続5日目と" + vbCrLf
                strSamHonbun = strSamHonbun + "　　当たる組合員が発生した場合には、極力所属基地までの勤務(乗務または便乗)とす" + vbCrLf
                strSamHonbun = strSamHonbun + "　　る｣に該当する場合に限り、第3項｢" + strYYYY + "年" + strMM + "月" + strDD + "日に連続4日目勤務が予定さ" + vbCrLf
                strSamHonbun = strSamHonbun + "　　れている者の、" + strYYYY1 + "年" + strMM1 + "月" + strDD1 + "日の勤務・便乗を一切拒否する。｣を解除する。" + vbCrLf + vbCrLf
            ElseIf (strKind = "05") Then
                strSamKenmei = "全日空乗組B第" + strStrikeId + "号、第1項(２)６)、に関する件、下記の通り。" + vbCrLf
                strSamHonbun = ""
                strSamHonbun = strSamHonbun + strYYYY + "年" + strMM + "月" + strDD + "日00時から24時間での24時間時限ストライキに関して、" + vbCrLf
                strSamHonbun = strSamHonbun + "次の業務に携わる場合、当該業務に限り当該者を解除する。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "１．羽田ー佐賀貨物深夜便の運航に携わる次の者。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　①F8553/8554便、又はF8555/8556便に乗務する者。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　②当該便にかかわるスタンバイの者。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "２．パスポート又はVISAを取得維持するため必要な業務に携わる、別紙記載の者。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "３．身体権者にかかわる業務に携わる、別紙記載の者。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "４．訓練・新車にかかわる業務に携わる、別紙記載の者。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "５．CRM研修にかかわる業務に携わる、別紙記載の者。" + vbCrLf + vbCrLf
                strSamHonbun = strSamHonbun + "６．札幌ー羽田線貨物深夜便の運航に携わる次の者。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　①F8552便(札幌→羽田)に乗務する者。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　②F8551便に乗務する者、及び当該便にかかわるスタンバイ中の者。" + vbCrLf
                strSamHonbun = strSamHonbun + "　　　(②は、突入の場合、決定時刻により判断)" + vbCrLf + vbCrLf
            End If
            If (Not ChkNull(txtKenmei.Text)) Or (Not ChkNull(txtHonbun.Text)) Then
                If CLMsg.Show("GQ0021", "件名", "本文") = DialogResult.Yes Then
    ...
    '別紙ボタン
    Private Sub btnBeshi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBeshi.Click

        Dim clsFormFM040207 As New FM040207()

        Try
            ' プロパティ設定
            clsFormFM040207.strStrikeId = Me.strStrikeId
            clsFormFM040207.strKind = Me.strKind
            clsFormFM040207.bytTabKind = Me.bytTabKind
            clsFormFM040207.bytStatus = Me.bytStatus
            clsFormFM040207.SelectDataList = Me.SelectDataList
            clsFormFM040207.strAnotherSubject = Me.strAnotherSubject


            '別紙画面の表示
            clsFormFM040207.ShowDialog()

            If clsFormFM040207.DialogResult = DialogResult.OK Then
                ' OKボタン押下時
                Me.SelectDataList = clsFormFM040207.SelectDataList
                strAnotherSubject = clsFormFM040207.strAnotherSubject
            End If

            ' 不要になった時点で破棄する
            clsFormFM040207.Dispose()
...
#Region "関数"
    Private Function controlScreen() As Boolean
        ...
        Try
            ...
            Me.btnBeshi.Visible = True
            If (strKind = "03") Then
                Me.lblTitle.Text = "争議行為解除通知－詳細"
                Me.Label5.Text = "【争議行為解除通知】"
            ElseIf (strKind = "04") Then
                Me.lblTitle.Text = "争議行為一部解除通知－詳細"
                Me.Label5.Text = "【争議行為一部解除通知】"
            ElseIf (strKind = "05") Then
                Me.lblTitle.Text = "全面24時間ストライキ一部解除通知－詳細"
                Me.Label5.Text = "【全面24時間時限ストライキに関する一部解除通知】"
            End If
            Me.txtUser.BackColor = Color.White
            If Me.strKind = "03" Then
                Me.btnBeshi.Visible = True
            Else
                Me.btnBeshi.Visible = False
            End If
            ...
            Select Case Me.bytStatus
                ...
                Case STATUS_DETAIL
                    ...
                    If (Me.bytTabKind = STATUS_TAB_HONB) Then
                        ...
                        strsql = strsql & "        stli.d_strike_start,stli.l_subject,stli.l_text,stli.l_another_subject, "
                        ...
                        Me.txtNoKanren.Text = NVL(dt.Rows(0).Item("c_basis_strike_id"))
                        ...
                        If (dt.Rows(0).Item("d_strike_start").ToString < Format(Now, DATE_YYYYMMDD_8_FORMAT)) Then
                            Me.btnUpdate.Visible = False
                        End If
                        Me.strAnotherSubject = NVL(dt.Rows(0).Item("l_another_subject"))
                        ...
                        If dt.Rows.Count > 0 Then
                            '列追加
                            Me.SelectDataList.Columns.Add("Column1")
                            Me.SelectDataList.Columns.Add("Column2")
                            Me.SelectDataList.Columns.Add("Column3")
                            Me.SelectDataList.Columns.Add("Column4")
                            '値投入
                            For i = 0 To dt.Rows.Count - 1
                                Call Me.SelectDataList.Rows.Add()    '行追加
                                Me.SelectDataList.Rows(i).Item(0) = dt.Rows(i).Item("c_user_name")
                                Me.SelectDataList.Rows(i).Item(1) = dt.Rows(i).Item("c_user_id")
                                Me.SelectDataList.Rows(i).Item(2) = dt.Rows(i).Item("model_name")
                                Me.SelectDataList.Rows(i).Item(3) = dt.Rows(i).Item("belong_name")
                            Next
                        End If
                    ElseIf (Me.bytTabKind = STATUS_TAB_TEMP) Then
                        ...
                        strsql = strsql & "        stli.d_strike,stli.l_stand_name,"
                        strsql = strsql & "        stli.d_strike_start,stli.l_subject,stli.l_text,stli.l_another_subject,"
                        strsql = strsql & "        stli.c_strike_work_id,stli.c_basis_strike_id"
                        ...
                        strsql = strsql & " and    staf.k_model  = cd2.c_constant_seq"
                        strsql = strsql & " and    cd2.c_constant  = 'MODEL'"
                        strsql = strsql & " order by stli.c_user_id" & UtDb.DbOrderOffset & ";"
                        'todo:
                        ' SQL実行
                        dt = clsDb.ExecuteSql(strsql)
    ...
    Private Function PrintPreview() As Boolean
        Dim blnRet As Boolean = False                                                       ' 処理結果
        Dim ds As DS0402P4 = Nothing                                                        ' 帳票用データセット
        Dim clsFM040207 As New FM040207()
        ...
        Dim drHeader As DS0402P4.dtHeaderRow = Nothing
        Dim drDetail As DS0402P4.dtDetailRow = Nothing
        ...
        Try
            ...
            drHeader.l_another_subject = strAnotherSubject
            ...
            '選択された組合員のリスト
            For i = 0 To Me.SelectDataList.Rows.Count - 1
                drDetail = ds.dtDetail.NewRow
                drDetail.BeginEdit()
                drDetail.c_staf_id = Me.SelectDataList.Rows(i).Item(1).ToString()
                drDetail.l_name = Me.SelectDataList.Rows(i).Item(0).ToString()
                drDetail.EndEdit()
            ...
            reportObj = New CR0402P4                                                        ' レポートドキュメント生成
    ...
    Private Function dataCheck() As Boolean
        ...
        Try
            ...
            If ChkNull(txtKenmei.Text) Then
                ...
                txtKenmei.BackColor = Color.LightPink
                Me.txtKenmei.Focus()
                Return False
            End If
            '本文 Check Null
            ...
            If (strKind = "03") Then
                intMaxLineCnt = 2
                If (lineCnt >= intMaxLineCnt) Then
                    CLMsg.Show("GE0103", "件名")
                    txtKenmei.BackColor = Color.LightPink
                    Me.txtKenmei.Focus()
                    Return False
                End If
        ...
        Try
            ...
            Select Case Me.bytTabKind
                Case STATUS_TAB_HONB
                    ...
                    strSql = strSql + "','"
                    ' 件名
                    strSql = strSql + txtKenmei.Text + "','"
                    ' 本文
                    strSql = strSql + txtHonbun.Text + "','"
                    ' 別紙件名
                    strSql = strSql + Me.strAnotherSubject + "','"
                    ' 備考
                    strSql = strSql + "','"
                    ' 作成日
                    ...
                    If Me.strKind = "03" Then
                        ...
                        If Me.SelectDataList.Rows.Count > 0 Then
                            'delete strike_work_member list
                            strSql = "delete from strike_member_list "
                            strSql = strSql + "where  c_strike_id = '" + c_strike_work_id + "';"
                            clsDb.ExecuteNonQuery(strSql)

                            'insert 選択された組合員のリスト
                            For i = 0 To Me.SelectDataList.Rows.Count - 1
                                strColumn1 = Me.SelectDataList.Rows(i).Item(1).ToString()
                                '一時保存テーブルへデータ挿入
                                strSql = "Insert into strike_member_list (c_strike_id, c_user_id, d_ins, c_user_id_ins) values('"
                                ' 一時保存争議ＩＤ
                                strSql = strSql + c_strike_work_id + "','"
                                ' 組合員
                                strSql = strSql + strColumn1 + "','"
                                ' 作成日
                                strSql = strSql + datToday + "','"
                                ' 作成者個人ＩＤ
                                strSql = strSql + MDLoginInfo.UserId + "');"
                ...
                Case STATUS_TAB_TEMP
                    ...
                    If Me.strKind = "03" Then
                        ...
                        If Me.SelectDataList.Rows.Count > 0 Then
                            'delete strike_work_member list
                            strSql = "delete from strike_work_member_list "
                            strSql = strSql + "where  c_strike_work_id = '" + c_strike_work_id + "';"
                            clsDb.ExecuteNonQuery(strSql)
        ...
        Try
            ...
            Select Case Me.bytTabKind
                Case STATUS_TAB_HONB
                    ...
                    strSql = strSql + "       l_another_subject  = '" + Me.strAnotherSubject + "',"
    ...
    Private Function TableTrans() As Boolean
        ...
        Try
            ...
            ' 別紙件名
            strSql = strSql + strAnotherSubject + "','"
            ' 備考
            strSql = strSql + "','"
            ' 作成日
            strSql = strSql + datToday + "','"
            ...
            If Me.strKind = "03" Then
                'select strike_work_member list
                strSql = "select * from strike_work_member_list "
                strSql = strSql + "where  c_strike_work_id = '" + strStrikeId + "';"
                clsDb.ExecuteNonQuery(strSql)
                ...
                If tbRet.Rows.Count > 0 Then
                    ' 1件以上の処理
                    For i = 0 To tbRet.Rows.Count - 1                                                              ' レコード数分ループ
                        '一時保存テーブルへデータ挿入
                        strSql = "Insert into strike_member_list (c_strike_id, c_user_id, d_ins, c_user_id_ins) values('"
                        ' 一時保存争議ＩＤ
                        strSql = strSql + c_strike_work_id + "','"
                        ' 組合員
                        strSql = strSql + tbRet.Rows(i).Item("c_user_id") + "','"
                        ' 作成日
                        strSql = strSql + datToday + "','"
                        ' 作成者個人ＩＤ
                        strSql = strSql + MDLoginInfo.UserId + "');"
                        clsDb.ExecuteNonQuery(strSql)
                    Next
                    'delete strike_work_member_list
                    strSql = "delete from strike_work_member_list "
                    strSql = strSql + "where  c_strike_work_id = '" + strStrikeId + "';"
                    clsDb.ExecuteNonQuery(strSql)
                End If
